/**
 * BTMTravel COBT - Create Demo Users Script
 * This script generates a valid bcrypt hash and creates SQL to insert demo users
 * 
 * Usage:
 *   1. npm install bcrypt (if not installed)
 *   2. node create-demo-users.js
 *   3. Copy the generated SQL and run it in PostgreSQL
 */
...
`;
    ...
    console.log('');
    console.log('   3. Test login with any of the demo accounts above!');
    console.log('\n✅ Done!\n');
